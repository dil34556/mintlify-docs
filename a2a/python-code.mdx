...
- A Telminator account at [app.telminator.com](https://app.telminator.com/)
...
1. Go to [Telminator Dashboard](https://app.telminator.com/)
...
if __name__ == "__main__":
    # Configuration
    AGENT_URL = os.getenv("AGENT_URL", "https://agent.telminator.com:10001/")
...
WARN: Agent card advertises local URL 'http://0.0.0.0:10002/'. Patching to 'https://agent.telminator.com:10001/' for remote access.
======= Agent Card ========
{
  "capabilities": {
  ...
  "url": "https://agent.telminator.com:10001/",
  "version": "1.0.0"
}
========= starting a new task ========
...
|-----------|------|-------------|---------|
| `url` | string | Agent URL | `https://agent.telminator.com:10001/` |
...
```python
AGENT_URL = "https://your-custom-agent.telminator.com/"
```
...
# agents_config.py
AGENTS = {
    "currency": "https://agent.telminator.com:10001/",
    "weather": "https://weather-agent.telminator.com/",
    "custom": "https://your-agent.telminator.com/"
}
...
```
  ...
  <Accordion title="Authentication failed">
    ...
    - Generate a new key from [app.telminator.com](https://app.telminator.com/#api-keys)
  </Accordion>
...
<Note>
**Need Help?** Visit the [Telminator Dashboard](https://app.telminator.com/) or check our GitHub repository for examples and support.
</Note>